...
const ConnectedBlocks = () => {
  return (
    <div className="container lg:flex sm:mt-[2rem] lg:ml-[5rem] xl:ml-[5rem] sm:ml-0">
      <div className="lg:ml-auto xl:w-[38rem] sm: mt-[3rem] md: mt-4 lg: mt-[10rem] xl: mt-4">
        ...
        <div className="relative left-1/2 flex h-[30rem] w-[20rem] md:w-[25rem] lg:w-[25rem] xl:w-[25rem] aspect-square border rounded-3xl border-n-6 -translate-x-1/2 scale:75 sm: mt-[5rem] md:scale-100 overflow-hidden">
