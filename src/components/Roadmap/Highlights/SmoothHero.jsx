...
import {CarChilling, Coding, WalkingCrowd, deskguy, deskman, MarioCoding, Sitting} from "../../../assets/Roadmap";
...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-96 bg-gradient-to-b from-bg-n-8 to-bg-n-8" />
    </div>
  );
};
...
const CenterImage = () => {
  ...
  return (
    <motion.div
      className="sticky top-[5] h-screen w-full"
      style={{
        clipPath,
        backgroundSize,
        opacity,
        backgroundImage: `url(${WalkingCrowd})`,
