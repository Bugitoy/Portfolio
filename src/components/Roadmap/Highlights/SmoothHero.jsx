...
const Schedule = () => {
  return (
    ...
    >
      ...
      <ScheduleItem title="Took a course on Nvidia's website talking about Accelerated Computing in Modern CUDA in C++" date="Sept 6th - Sept 27th 2025" location="Ohio" project="N/A"/>
      ...
      <ScheduleItem title="Continued collecting all the names of various universities of every country around the world."  date="Aug 3rd 2025" location="Ohio" project="study-talk.com Website"/>
      ...
      <ScheduleItem title="Built a website scraper using python and gemini run locally using Ollama to collect the names of universities from around the world from a 
                           webpage containing this data then arrange it for proper storage to allow users to choose their universities on the study-talk.com website" date="Aug 2 2025" location="Ohio" />
      ...
      <ScheduleItem title="Learned how NodeMailer works" date="Jul 29th 2025" location="Ohio" />
      ...
      <ScheduleItem title="Tried to create Kinde Auth custom login and signup pages using their github repo" date="Jul 24th 2025" location="Ohio" />
       <ScheduleItem
      ...
      <ScheduleItem title="Utilised localstorage to store room settings for video call, added API routes to store user answers to quiz questions, 
                          ...
                          changes, added more files to the hooks folder, and more. " date="Jul 11th 2025" location="Ohio" project="study-talk.com Website"/>
      ...
      <ScheduleItem title="Massive update on the study-talk.com website: created the omegle style videoCall functionality using websockets, learned 
                          ...
                          confessions." date="Jul 10th 2025" location="Ohio" project="study-talk.com Website"/>
      ...
      <ScheduleItem title="The dictionary website was becoming too big so I split the site into 2 seperate parts, one site that provides dedicated English to 
                            ...
                            website is called study-talk.com and it was built around the video conferencing functionality" date="Jul 9 2025" location="Ohio" project="Thanodi Dictionary Website & study-talk.com" />
      ...
      <ScheduleItem title="Began translating and adapting the repository’s architecture for integration into a Next.js + Prisma + MongoDB codebase. 
                          ...
                          separate standalone Socket.IO server." date="Jul 2nd 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Successfully cloned, configured, and ran a complex open-source Omegle-like project using React, Redis, and Socket.IO, overcoming 
                          ...
                          execution, and troubleshooting." date="Jul 2nd 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Attempted integration of GetStream.io WebRTC, identifying limitations for random-pairing functionality and evaluating alternative solutions. 
                          Also conducted extensive research on Omegle-style architectures, reviewing multiple GitHub repositories and analyzing real-world implementations." date= "Jul 1st 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Added meeting functionality, including an “enter code” field and “start room” button for joining online rooms" date="Jun 30 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Created a Leaderboard system to rank users based on study session duration" date="Jun 30 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Designed and built the Confessions page frontend, featuring a Reddit-style interface for posting and reacting to university confessions" date="Jun 30 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Implemented the core backend logic for the Study Group page, enabling fully functional study session tracking" date="Jun 29 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Developed multiple Meetups features, including Study Groups, Confessions, Online Competitions, and an Omegle-style random chat system" date="Jun 28 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Expanded the Thanodi platform by completing the full tutorial and adding a new Meetups section to the site’s navigation" date="Jun 27 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Began learning about how Zoom video conferencing works through WebRTC by watching a youtube tutorial utilising getstream-io" date="Jun 25th 2025" location="Ohio" project="N/A"/>
      
      <ScheduleItem title="Coded for the whole day and slept at 4:36am" date="Jun 24th 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Removed the saved words page and moved it to the home page instead of making it into a dedicated page, added the tab bar, sidebar
                          and more to the website" date="Jun 24th 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Managed to implement voice pronounciation fallback feature whereby the dictionary website utilises
                            ...
                            the site fallbacks to the browser's tts" date="Jun 24th 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Utilised Googles Text-To-Speech API (TTS) as a fallback incase the audio files from cloudinary can't be accessed by
                          by my website for some reason or if an error occurs" date="Jun 23rd 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Researched about storing audio files using AWS S3 buckets and Cloudinary to allow pronounciations of words to be 
                          made. Also researched about setswana dictionaries online." date="Jun 21st 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Fixed an error occurring when someone tries to cancel their subscription. 
                          ...
                          Also reminded myself about REST APIs." date="Jun 20th 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Fixed UI errors on the website and also reduced redundancies to make the code more cleaner" date="Jun 19th 2025" location="Ohio" project="Thanodi Dictionary Website"/>

      <ScheduleItem title="Learned more about radix-ui and also built the UI of the Thanodi dictionary website using Builder.io" date="Jun 18th 2025" location="Ohio" project="Thanodi Dictionary Website"/>
      ...
      <ScheduleItem title="Decided to learn about Next.js, how app router works, global.css, tsconfig.json, etc. Also learned about TanStack/react-Query package, 
                          radix-ui and next-themes" date="Jun 17th 2025" location="Ohio" project="N/A"/>

      <ScheduleItem title="Began working on Thanodi, an online dictionary website that translates from english to setswana and vice versa" date="Jun 16th 2025" location="Ohio" project="Thanodi Dictionary Website"/>      

      <ScheduleItem title="Decided to deepen my knowledge about stripe by watching a dedicated tutorial about it" date="Jun 7th 2025" location="Ohio" project="N/A"/>

      <ScheduleItem title="Decided to implement my knowledge of MERN by building an E-commerce store with authentication measures e.g bcrypt and also utilised stripe" date="May 30th 2025" location="Ohio" project="E-Commerce Store Website"/>
      
      <ScheduleItem title="Reminded myself how to backend program using MERN stack through watching a tutorial on YouTube" date="May 27th 2025" location="Ohio" project="N/A"/>

      <ScheduleItem title="Fixed projects page so that it looks proper on small screens and I was then done coding my personal website" date="Mar 3rd 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Made a few improvements to the responsiveness of Blog and made changes to other pages" date="Mar 2nd 2025" location="Ohio" project="Portfolio Website"/>
      
      <ScheduleItem title="Made a lot of changes to Blog Page and made fixes to other webpages" date="Mar 1st 2025" location="Ohio" project="Portfolio Website"/>
      
      <ScheduleItem title="Completed the Blog and Roadmap pages then added some finishing touches on the website" date="Feb 9th 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Fixed a lot of bugs and deployed the website on vercel" date="Feb 9th 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Made some changes to the Blog and Roadmap pages" date="Feb 8th 2025" location="Ohio"project="Portfolio Website" />

      <ScheduleItem title="Made the Projects page" date="Feb 7th 2025" location="Ohio" project="Portfolio Website"/>
 
      <ScheduleItem title="Made initial sketches of the Projects, Blog and Roadmap pages" date="Jan 25th 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Finished making the About Me page" date="Jan 23rd 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Finished the Home page of my personal website" date="Jan 17th 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Made a tiktok video based on the car website" date="Jan 15th 2025" location="Ohio" project="N/A"/>
      
      <ScheduleItem title="Went on to code a car website" date="Jan 7th 2025" location="Ohio" project="Car Website"/>

      <ScheduleItem title="Started coding this personal website" date="Jan 5th 2025" location="Ohio" project="Portfolio Website"/>

      <ScheduleItem title="Finished the website but couldn't submit my work on time, but instead published the code to github" date="Nov 11th 2024" location="Ohio" project="SchooLama"/>

      <ScheduleItem title="Began coding an alternative, user friendly school management system to Canvas for MakeUC Hackathon" date="Nov 10th 2024" location="Ohio" project="SchooLama"/>
    
    </section>
  );
};

const ScheduleItem = ({ title, date, location, project }) => {
  return (
    <motion.div
      initial={{ y: 48, opacity: 0 }}
      whileInView={{ y: 0, opacity: 1 }}
